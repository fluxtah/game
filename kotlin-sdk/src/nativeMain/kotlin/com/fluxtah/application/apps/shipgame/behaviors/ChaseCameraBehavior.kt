...
class ChaseCameraBehavior(
    private var offset: Vector3 = Vector3(0f, 3f * 6, -4.2f * 6),
    private var position: Vector3 = Vector3(),
    private var smoothingFactor: Float = 20.0f // Adjust for desired smoothing
) : CameraBehavior() {
    ...
    override fun update(time: Float) {
        ...
        val targetOrientation = target.getOrientation()
        val rotatedOffset = targetOrientation.rotateVector(offset)

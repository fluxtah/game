...
class KillerCameraBehavior(
    private var offset: Vector3 = Vector3(32f, 32f, 32f),
    var position: Vector3 = Vector3(),
    private var smoothingFactor: Float = 0.5f // Adjust for desired smoothing
) : CameraBehavior() {
    ...
    override fun update(time: Float) {
        ...
        val rotatedOffset = rotateOffsetByTargetYaw(offset, 0f)

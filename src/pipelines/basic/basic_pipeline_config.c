...
PipelineConfig *createBasicShaderPipelineConfig(
    ...
    pipelineConfig->samplerDescriptorSetLayout = createBasicPipelineSamplerDescriptorSetLayout(context->device);
    ...
    pipelineConfig->pipelineLayout = createBasicPipelineLayout(
            context->device,
            pipelineConfig->vertexShaderDescriptorSetLayout,
            pipelineConfig->fragmentShaderDescriptorSetLayout,
            pipelineConfig->samplerDescriptorSetLayout);

...
VkDescriptorSetLayout createPfxComputePipelineDescriptorSetLayout(VkDevice device) {
    ...
    VkDescriptorSetLayoutBinding emitterParamsBinding = {};
    emitterParamsBinding.binding = 1;
    emitterParamsBinding.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    emitterParamsBinding.descriptorCount = 1;
    emitterParamsBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    emitterParamsBinding.pImmutableSamplers = NULL;

    VkDescriptorSetLayoutBinding bindings[] = {
            ssboLayoutBinding,
            emitterParamsBinding,
    };

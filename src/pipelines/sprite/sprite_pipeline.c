...
VkPipeline createSpritePipeline(
    ...
    attributeDescriptions[2].offset = offsetof(SpriteVertex, color);
    ...
    colorBlendAttachment.blendEnable = VK_TRUE; // Set to VK_TRUE if you need blending
    ...
    if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, NULL, &graphicsPipeline) != VK_SUCCESS) {
        fprintf(stderr, "Failed to create SPRITE graphics pipeline\n");
        return NULL;
    }
